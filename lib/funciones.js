...
function cargarDatosTareaResponsable(){
	...
	jQuery.get("http://localhost:8000/preReasignarTarea/"+tarea,function(resultado){
...
function reasignarRespTarea(){
	...
	if(localStorage.obs!=''){
		if(y[x].index!=0){
			...
			jQuery.get("http://localhost:8000/reasignarTarea/"+localStorage.tarea+"/"+localStorage.respi+"/"+localStorage.obs+"/"+localStorage.nombre,function(resultado){
				data = jQuery.parseJSON(resultado);
				localStorage.obs='';
				location.href="DetalleTarea.html";
			});
...
function cargarProyectosAbiertos(){
	...
	jQuery.get("http://localhost:8000/listaProyAoC/"+localStorage.nombre+"/A",function(resultado){
		data = jQuery.parseJSON(resultado);
		$.each(data, function(i, elemento){
...
function cargarProyectosCerrados(){
	...
	jQuery.get("http://localhost:8000/listaProyAoC/"+localStorage.nombre+"/C",function(resultado){
		data = jQuery.parseJSON(resultado);
		$.each(data, function(i, elemento){
			html = html + '<li><a onClick="consultarProyecto(' + elemento.sec + ')" id="' + elemento.sec + '"> PROYECTO #'+elemento.sec+'<br></br><p> '+elemento.id+'; '+elemento.empinst+'; '+ elemento.estatus_absoluto +'</p></a></li>'; 
		});
...
function cargarDetallesProyecto() {
	...
	jQuery.get("http://localhost:8000/listaProyDetalle/"+proy,function(resultado){
		data = jQuery.parseJSON(resultado);
		$.each(data, function(i, elemento){					
...
function cargarProductosAbiertos(){
	...
	jQuery.get("http://localhost:8000/listaProdAoC/"+localStorage.proy+"/A",function(resultado){
		data = jQuery.parseJSON(resultado);
		$.each(data, function(i, elemento){
...
function cargarProductosCerrados(){
	...
	jQuery.get("http://localhost:8000/listaProdAoC/"+localStorage.proy+"/C",function(resultado){
		data = jQuery.parseJSON(resultado);
		$.each(data, function(i, elemento){
			html = html + '<li><a onClick="consultarProducto(' + elemento.sec + ')" id="' + elemento.sec + '"> PRODUCTO #'+elemento.sec+'<br></br><p> '+elemento.id+'; '+elemento.empinst+'; '+ elemento.estatus_absoluto +'</p></a></li>'; 
		});
...
function cargarDetallesProducto() {
	...
	jQuery.get("http://localhost:8000/listaProdDetalle/"+prod,function(resultado){
	data = jQuery.parseJSON(resultado);
	$.each(data, function(i, elemento){	
...
function cargarDatosProdResponsable(){
	...
	jQuery.get("http://localhost:8000/preReasignarProducto/"+prod,function(resultado){
	data = jQuery.parseJSON(resultado);
	$.each(data, function(i, elemento){
		if(i==0){
...
function reasignarRespProd(){
	...
	if(localStorage.obs!=''){
		if(y[x].index!=0){
			localStorage.respi = y[x].text;
			jQuery.get("http://localhost:8000/reasignarProducto/"+localStorage.prod+"/"+localStorage.respi+"/"+localStorage.obs+"/"+localStorage.nombre,function(resultado){
				data = jQuery.parseJSON(resultado);
				localStorage.obs='';
				location.href="DetalleProducto.html";
			});
...
function cargarTareaRRHH() {
	...
	jQuery.get("http://localhost:8000/listaRecursosT/"+tarea,function(resultado){
	data = jQuery.parseJSON(resultado);
	$.each(data, function(i, elemento){
...
function cargarDatosRRHH_t() {
	...
	var html = '<div data-role="content">';
		...
		jQuery.get("http://localhost:8000/selectTareaRRHH/"+tarea,function(resultado){
		jQuery.get("http://localhost:8000/selectRoles/"+tarea,function(resultado2){
		data = jQuery.parseJSON(resultado);
...
function agregarRRHHtarea() {
	...
	if(rrhh_[x].index!=0 && rol_[y].index!=0){
		...
		rol = rol_[y].text;
		location.href="DetalleRRHHTarea.html";
		jQuery.get("http://localhost:8000/insertarRRHHtarea/"+tarea+"/"+usr+"/"+rrhh+"/"+rol,function(resultado){
		});				
	}else{
...
function cargarProyRRHH() {
	...
	jQuery.get("http://localhost:8000/listaRecursosP/"+proy,function(resultado){
	data = jQuery.parseJSON(resultado);
	$.each(data, function(i, elemento){
		html = html + '<li>'+elemento.rrhh+'</br><br><p>'+elemento.rol+'</p></a></li>';
		});
...
function cargarDatosRRHH_P() {
	...
	var html = '<div data-role="content">';
			html += '<label for="selectRRHH" class="select">RRHH:</label><select name="selectRRHH" id="selectRRHH" data-theme="b"><option value="">Seleccionar</option>' ;	
		jQuery.get("http://localhost:8000/selectProyRRHH/"+proy,function(resultado){
		jQuery.get("http://localhost:8000/selectRoles/"+proy,function(resultado2){
		data = jQuery.parseJSON(resultado);
		data2 = jQuery.parseJSON(resultado2);
		$.each(data, function(i, elemento){
			html+='<option value="RRHH '+elemento.rrhh+'">'+elemento.rrhh+'</option>';
...
function agregarRRHHproy() {
	...
	if(rrhh_[x].index!=0 && rol_[y].index!=0){
		...
		rol = rol_[y].text;
		location.href="DetalleRRHHProyecto.html";
		jQuery.get("http://localhost:8000/insertarRRHHproy/"+proy+"/"+usr+"/"+rrhh+"/"+rol,function(resultado){
		});				
	}else{
		alert("Debe seleccionar el RRHH y el Rol a asignar");
	}	
...
function cargarEstadisticasProy(){
	...
	jQuery.get("http://localhost:8000/listaEstProy/"+localStorage.nombre,function(resultado){
	data = jQuery.parseJSON(resultado);
	$.each(data, function(i, elemento){
		if (elemento.tam == 7) {
...
function cargarEstadisticasProd(){
	...
	jQuery.get("http://localhost:8000/listaEstProd/"+localStorage.nombre,function(resultado){
	data = jQuery.parseJSON(resultado);
	$.each(data, function(i, elemento){
		if (elemento.tam == 8) {
...
function cargarEstadisticasTarea(){
	...
	jQuery.get("http://localhost:8000/listaEstTarea/"+localStorage.nombre,function(resultado){
	data = jQuery.parseJSON(resultado);
	$.each(data, function(i, elemento){
		if (elemento.tam == 8) {
...
function cargarEstProy_proy(){
	...
	jQuery.get("http://localhost:8000/listaFases_Est/"+proy,function(resultado){
	data = jQuery.parseJSON(resultado);
	$.each(data, function(i, elemento){
...
function cargarEstFase_proy(){
	...
	jQuery.get("http://localhost:8000/listaProd_Est/"+proy+"/"+fase,function(resultado){
	data = jQuery.parseJSON(resultado);
	$.each(data, function(i, elemento){
...
function cargarEstProd_proy(){
	...
	jQuery.get("http://localhost:8000/listaTarea_Est/"+prod,function(resultado){
	data = jQuery.parseJSON(resultado);
	$.each(data, function(i, elemento){
...
function cargarEstTarea_proy(){
	...
	jQuery.get("http://localhost:8000/datosTarea_Est/"+tarea,function(resultado){
	data = jQuery.parseJSON(resultado);
	$.each(data, function(i, elemento){
